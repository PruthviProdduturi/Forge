...
# Source: forge_demo_bronze.forge.ts  |  Layer: bronze
# Regenerate: forge generate --job forge_demo_bronze
# CI check:   forge generate --check --job forge_demo_bronze
# ==============================================================
...
Schedule:  0 2 * * *
Params:
  PARTITION_DATE: string (default: ) — Target date (yyyy-MM-dd). Defaults to data_interval_start.
...
PARTITION_DATE = os.environ.get("PARTITION_DATE", "")  # Target date (yyyy-MM-dd). Defaults to data_interval_start.
