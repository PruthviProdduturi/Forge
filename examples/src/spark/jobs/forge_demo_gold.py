...
# Source: forge_demo_gold.forge.ts  |  Layer: gold
# Regenerate: forge generate --job forge_demo_gold
# CI check:   forge generate --check --job forge_demo_gold
# ==============================================================
...
Params:
  ...
  GOLD_TABLE: string [required] — daily_sales | product_performance | regional_metrics
...
GOLD_TABLE = os.environ["GOLD_TABLE"]  # daily_sales | product_performance | regional_metrics
