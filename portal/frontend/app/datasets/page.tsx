...
export default function DatasetsPage() {
  ...
  return (
    ...
    >
      ...
      <div style={{ background: "#fff", border: `1px solid ${error ? "#fca5a5" : "#e2e8f0"}`, borderTop: `3px solid ${error ? "#ef4444" : ACCENT}`, borderRadius: 12, boxShadow: "0 1px 4px rgba(0,0,0,0.05)" }}>
