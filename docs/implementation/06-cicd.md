...
Stage 5: Smoke Tests              (after Stage 4)
  └── job: smoke-test
        ...
        Assert lineage graph visible in the Developer Portal for the test DAG
...
stages:
  ...
  - stage: OrchApps        # stage 5 — orchestration cluster apps (Airflow, OpenLineage integration)
    dependsOn: AKSBootstrap
